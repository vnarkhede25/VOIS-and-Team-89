#!/usr/bin/env python3
"""
Test New Guardian + Elderly Registration Workflow
"""
...
def test_new_registration_workflow():
    """Test complete workflow for new guardian and elderly registration"""
    print("👥 TESTING NEW GUARDIAN + ELDERLY REGISTRATION")
    print("=" * 60)
    ...
    # Test 2: Register new elderly
    print("\n2️⃣ REGISTERING NEW ELDERLY...")
    elderly_data = {
        "elderly_id": "test_elderly_new",
        "name": "Test Elderly",
        "age": 75,
    ...
    if "vois_belt" in elderly_data:
        elderly_data["vois_belt"]["current_user"] = "test_elderly_new"
...
if __name__ == "__main__":
    test_new_registration_workflow()
